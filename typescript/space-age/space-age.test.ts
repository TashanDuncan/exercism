...
import {Mars, SpacePort} from './space-age'
describe('Space Age', () => {
  // it('age on Earth', () => {
  ...
  it('age on Mars', () => {
    const NewMars = new Mars(2129871239)
    expect(NewMars.getPlanetAge()).toEqual(35.88)
    expect(NewMars.getEntityType()).toEqual('Planet')
  })
